...
def generate_response(user_input, previous_context):
    try:
        ...
        # Obtém o conteúdo do PDF armazenado na sessão
...
def upload_pdf():
    ...
    # Armazena o conteúdo do PDF na sessão
    session['pdf_content'] = pdf_text
    print(f"Conteúdo extraído do PDF: {pdf_text[:500]}")  # Exibir os primeiros 500 caracteres
